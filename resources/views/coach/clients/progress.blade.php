<x-app-layout>
    <x-slot name="header">Progress Klien: {{ $client->name }}</x-slot>

    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Grafik & Riwayat Capaian</div>
                    <div class="card-category">Memantau perkembangan berat badan dan fisik klien.</div>
                </div>
                <div class="card-body">
                    {{-- GRAFIK / CHART --}}
                    @if($logs->count() > 0)
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">Belum ada progress dicatat klien ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: weights,
                                borderColor: '#31ce36', // Success color for coach view
